//  import { sortByRatings } from "../actions/restaurantAction.js";
import {
  ...
  switch (action.type) {
    ...
    case ALL_RESTAURANTS_SUCCESS:
      return {
        ...
        // restaurants: action.payload,
        count: action.payload.count,
        restaurants: action.payload, // Update this line to access the restaurants data
      };
